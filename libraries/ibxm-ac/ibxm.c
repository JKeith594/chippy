...
static char* data_ascii( struct moddata *data, int offset, int length, char *dest ) {
	int idx, chr;
...
static int data_s8( struct moddata *data, int offset ) {
	int value = 0;
	if( offset < data->length ) {
...
static int data_u8( struct moddata *data, int offset ) {
	int value = 0;
	if( offset < data->length ) {
...
static int data_u16be( struct moddata *data, int offset ) {
	int value = 0;
...
static int data_u16le( struct moddata *data, int offset ) {
	int value = 0;
	if( offset + 1 < data->length ) {
		value = ( data->buffer[ offset ] & 0xFF )
...
static unsigned int data_u32le( struct moddata *data, int offset ) {
...
static void data_sam_s8( struct moddata *data, int offset, int count, short *dest ) {
...
static void data_sam_s16le( struct moddata *data, int offset, int count, short *dest ) {
	int idx, amp, length = data->length;
	char *buffer = data->buffer;
	if( offset > length ) {
		offset = length;
...
static struct module* module_load_xm( struct moddata *data, char *message ) {
...
static struct module* module_load_s3m( struct moddata *data, char *message ) {
...
static struct module* module_load_mod( struct moddata *data, char *message ) {
...
struct module* module_load( struct moddata *data, char *message ) {
	char ascii[ 16 ];
	struct module* module;
